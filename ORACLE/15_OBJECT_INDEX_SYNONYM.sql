/*
    INDEX
    SQL 명령문의 처리속도를 향상시키기 위해서 행들의 위치 정보를 가지고 있다.
    
    * 데이터 검색 방식
    1. Table Full Scan : 테이블 데이터를 처음부터 끝가지 검색하여 원하는 데이터를 찾는 방법
...
-- 결합 인덱스 생성
CREATE INDEX IDX_STUDENT_CLASS_NOP
...
/*
    ...
    - 정확한 데이터 분석에 기반을 두지 않은 무분별한 인덱스는 오히려 성능을 저하시킴
*/
